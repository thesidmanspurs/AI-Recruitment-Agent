...
export const adminService = {
  ...
  async listUsers(params: PageParams): Promise<Paginated<{
    ...
    const data = users.map(u => ({
      ...
      sourcingAddonActive: u.sourcingAddonActive,
      rankingAddonActive: u.rankingAddonActive,
    ...
    const [activeSubscriptions, revenueAgg, balanceAgg, subscribers, recent] = await Promise.all([
      ...
      prisma.user.findMany({
        ...
        select: {
          ...
          planType: true, subscriptionStatus: true, subscriptionPlan: true, subscriptionCurrentPeriodEnd: true,
          sourcingAddonActive: true, rankingAddonActive: true,
        },
