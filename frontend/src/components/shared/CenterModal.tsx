  ...
  return (
    <div className="fixed inset-0 z-30 flex items-center justify-center p-4">
      ...
      <div
        ...
        className={`relative w-full ${WIDTHS[size]} bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]`}
      >
        <header className="px-6 py-4 border-b border-gray-100 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h2 id="modal-title" className="text-base font-bold text-gray-900 truncate">
                {title}
              </h2>
              {subtitle && (
          ...
          <button
            onClick={onClose}
            aria-label="Close"
            className="w-8 h-8 rounded-md flex items-center justify-center text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-colors shrink-0"
          >
            <X className="w-4 h-4" />
          </button>
        </header>
        ...
        {footer && (
          <footer className="px-6 py-4 border-t border-gray-100 flex items-center justify-end gap-2 shrink-0 bg-gray-50/60">
            {footer}
          </footer>
        )}
      </div>
