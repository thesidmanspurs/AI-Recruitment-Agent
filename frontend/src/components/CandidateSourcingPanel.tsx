    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border rounded-2xl p-5 shadow-xs flex flex-col md:flex-row gap-5 items-start md:items-center justify-between">
        ...
        <button
          ...
          className="w-full md:w-auto flex items-center justify-center gap-1.5 bg-gray-900 dark:bg-gray-700 hover:bg-gray-100 dark:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed text-white text-xs font-semibold px-5 py-3 rounded-xl transition duration-150 shadow-sm"
        >
          {isSourcingLoading ? (
        ...
        <div className="lg:col-span-1 bg-slate-50 border border-slate-200/60 rounded-2xl p-4 space-y-5 shadow-xs">
                ...
                <button
                  ...
                  className={`flex items-center justify-between text-xs px-3 py-2 rounded-lg text-left transition duration-150 ${
                    filters.platform === platform
                      ? 'bg-white text-gray-700 dark:text-gray-300 font-semibold shadow-xs border border-slate-200/80'
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center">
                <input
                  ...
                  className="w-4 h-4 text-gray-700 dark:text-gray-300 border-slate-200 rounded focus:ring-0"
                />
              </div>
            </div>
          ...
          <div className="space-y-2 pt-1">
            <div className="flex justify-between items-center">
              ...
              <span className="text-xs font-mono font-bold text-gray-700 dark:text-gray-300">{filters.minScore.toFixed(1)} / 10</span>
            </div>
            <input
              type="range"
              min="0"
              ...
              {filteredCandidates.map(candidate => (
                ...
                >
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div className="relative">
                          <div className={`w-10 h-10 rounded-full bg-indigo-50 text-gray-700 dark:text-gray-300 font-bold text-sm flex items-center justify-center border-2 ${
                            candidate.openToWork ? 'border-emerald-500 ring-2 ring-emerald-500/20' : 'border-gray-200 dark:border-gray-700'
                          }`}>
                      ...
                      <div className="text-right">
                        <span className={`text-[11px] font-mono font-bold px-2 py-0.75 rounded ${
                          candidate.matchScore >= 9.5 
                            ...
                            : 'bg-indigo-50 text-gray-700 dark:text-gray-300'
                        }`}>
                  ...
                  <div className="pt-3.5 border-t border-slate-100 mt-4 flex justify-between items-center text-[10px]">
                    ...
                    <span className="text-gray-700 dark:text-gray-300 font-sans font-bold shrink-0 hover:underline inline-flex items-center gap-0.5">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  ...
                  <div className="md:col-span-1 bg-slate-50 border p-4 rounded-xl text-center space-y-2">
                    ...
                    <span className={`inline-block text-[10px] font-sans font-bold px-2 py-0.5 rounded leading-none ${
                      selectedCandidate.matchScore >= 9.5 ? 'bg-emerald-50 text-emerald-700' : 'bg-indigo-50 text-gray-700 dark:text-gray-300'
                    }`}>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {!selectedCandidate.outreachMessage && (
                      <button
                        ...
                        className="bg-gray-100 dark:bg-gray-800 hover:bg-gray-100 dark:bg-gray-800 disabled:opacity-50 text-white text-xs font-medium px-4 py-2 rounded-xl flex items-center gap-1 transition-all duration-150"
                      >
                  ...
                  {selectedCandidate.outreachMessage ? (
                    <div className="space-y-2">
                      <textarea
                        ...
                        rows={6}
                        className="w-full bg-slate-900 text-slate-300 font-mono text-xs p-3.5 rounded-xl border border-slate-800 leading-relaxed focus:outline-none focus:ring-1 focus:ring-gray-400"
                      />
                      <div className="flex items-center justify-between text-[11px] text-slate-400">
                        <span>Score: {selectedCandidate.matchScore} &gt; 9.5 automatically triggers priority channel routing.</span>
                        <button
                          onClick={() => handleDraftMessage(selectedCandidate)}
                          className="hover:text-gray-700 dark:text-gray-300 font-semibold"
                        >
                          Regenerate message ⟳
                        </button>
                      </div>
